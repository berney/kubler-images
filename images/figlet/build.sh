...
#     kubler.sh build -i berne/figlet
...
finish_rootfs_build()
{
    ...
    #export DISTRIBUTION_DIR="${GOPATH}/src/github.com/berne/figlet"
    #mkdir -p "${DISTRIBUTION_DIR}"

    #git clone https://github.com/berne/figlet.git "${DISTRIBUTION_DIR}"
    #cd "${DISTRIBUTION_DIR}"
    #git checkout tags/v${_figlet_version}
    #echo "building figlet ${_figlet_version}.."
    ...
    #log_as_installed "manual install" "figlet-${_figlet_version}" "https://figlet.org/"
