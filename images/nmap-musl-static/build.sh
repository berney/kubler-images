...
configure_bob()
{
    ...
    #emerge -F dev-libs/libressl net-misc/wget
    ...
    #update_use 'net-analyzer/nmap' '+ipv6' '+libressl' '+libssh2' '+ncat' '+nping' '+nse' '+ssl' '-system-lua' '+static'
    update_use 'net-analyzer/nmap' '+ipv6' '+libssh2' '+ncat' '+ndiff' '+nping' '+nls' '+nse' '+ssl' '+static' '+symlink' '-zenmap'
    # global
...
configure_rootfs_build()
{
    ...
    provide_package 'dev-lang/lua'
    provide_package 'dev-libs/libpcre2'
    provide_package 'dev-libs/liblinear'
    provide_package 'dev-libs/openssl'
