...
#     kubler.sh build -i berney/fd
# ..and then search the Portage database:
#     eix <search-string>
_packages="sys-apps/fd"
...
finish_rootfs_build()
{
    ...
    #export DISTRIBUTION_DIR="${GOPATH}/src/github.com/berney/fd"
    #mkdir -p "${DISTRIBUTION_DIR}"

    #git clone https://github.com/berney/fd.git "${DISTRIBUTION_DIR}"
    #cd "${DISTRIBUTION_DIR}"
    #git checkout tags/v${_fd_version}
    #echo "building fd ${_fd_version}.."
    ...
    #log_as_installed "manual install" "fd-${_fd_version}" "https://fd.org/"
